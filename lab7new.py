...
class MainWindow(QMainWindow):
    ...
    def create_staff_form(self):
        ...
        self.staff_form_error_label.setStyleSheet("color: red; padding: 10px; background-color: #FADBD8; border-radius: 5px;")
    ...
    def create_inventory_form(self):
        ...
        self.inv_form_error_label.setStyleSheet("color: red; padding: 10px; background-color: #FADBD8; border-radius: 5px;")
